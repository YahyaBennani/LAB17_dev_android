package com.example.lab17_dev_android;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void sendCustomBroadcast() {
        Intent intent = new Intent("com.example.lab17_dev_android.CUSTOM_EVENT");
        intent.setPackage(getPackageName()); // Nécessaire pour les receivers statiques sur Android 8+
